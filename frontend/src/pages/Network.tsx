      ...
      <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-black text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-300 mb-4">Want to join our professional network?</p>
            <Link
              to="/join-network/expert"
        ...
        <div className="mt-12 bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl p-8 text-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-4">Join Our Professional Network</h2>
              <p className="text-indigo-200">
                Connect with entrepreneurs, share your expertise, and grow your practice. Choose your role below.
              </p>
            </div>
            <div className="grid md:grid-cols-4 gap-4">
              <Link
                to="/join-network/expert"
                className="bg-white/10 backdrop-blur hover:bg-white/20 rounded-xl p-6 text-center transition-all hover:scale-105"
              >
                <Users className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-semibold mb-1">Expert</h3>
                <p className="text-sm text-indigo-200">Share expertise & consult</p>
              </Link>
              <Link
                to="/join-network/investor"
                className="bg-white/10 backdrop-blur hover:bg-white/20 rounded-xl p-6 text-center transition-all hover:scale-105"
              >
                <TrendingUp className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-semibold mb-1">Investor</h3>
                <p className="text-sm text-indigo-200">Find deal opportunities</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-indigo-200">Offer business services</p>
              </Link>
              <Link
                to="/join-network/lender"
                className="bg-white/10 backdrop-blur hover:bg-white/20 rounded-xl p-6 text-center transition-all hover:scale-105"
              >
                <Building2 className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-semibold mb-1">Lender</h3>
                <p className="text-sm text-indigo-200">Finance acquisitions</p>
              </Link>
            </div>
          </div>
        </div>
